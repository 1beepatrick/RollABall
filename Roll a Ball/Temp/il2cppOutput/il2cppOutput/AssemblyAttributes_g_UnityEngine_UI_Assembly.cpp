...
extern MethodInfo GuidAttribute__ctor_m2093_MethodInfo;
...
void g_UnityEngine_UI_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(Object_t *) * cache->count, 0);
	{
		...
		AssemblyTitleAttribute__ctor_m2086(tmp, il2cpp_codegen_string_new_wrapper("guisystem"), &AssemblyTitleAttribute__ctor_m2086_MethodInfo);
	...
	}
	{
		...
		AssemblyDescriptionAttribute__ctor_m2087(tmp, il2cpp_codegen_string_new_wrapper(""), &AssemblyDescriptionAttribute__ctor_m2087_MethodInfo);
	...
	}
	{
		...
		AssemblyCompanyAttribute__ctor_m2089(tmp, il2cpp_codegen_string_new_wrapper("Microsoft"), &AssemblyCompanyAttribute__ctor_m2089_MethodInfo);
	...
	}
	{
		...
		AssemblyProductAttribute__ctor_m2090(tmp, il2cpp_codegen_string_new_wrapper("guisystem"), &AssemblyProductAttribute__ctor_m2090_MethodInfo);
	...
	}
	{
		...
		AssemblyCopyrightAttribute__ctor_m2091(tmp, il2cpp_codegen_string_new_wrapper("Copyright © Microsoft 2013"), &AssemblyCopyrightAttribute__ctor_m2091_MethodInfo);
	...
	}
	{
		...
		AssemblyFileVersionAttribute__ctor_m2092(tmp, il2cpp_codegen_string_new_wrapper("1.0.0.0"), &AssemblyFileVersionAttribute__ctor_m2092_MethodInfo);
		cache->attributes[7] = (Il2CppObject*)tmp;
	}
	{
		GuidAttribute_t421 * tmp;
		tmp = (GuidAttribute_t421 *)il2cpp_codegen_object_new (&GuidAttribute_t421_il2cpp_TypeInfo);
		GuidAttribute__ctor_m2093(tmp, il2cpp_codegen_string_new_wrapper("d4f464c7-9b15-460d-b4bc-2cacd1c1df73"), &GuidAttribute__ctor_m2093_MethodInfo);
