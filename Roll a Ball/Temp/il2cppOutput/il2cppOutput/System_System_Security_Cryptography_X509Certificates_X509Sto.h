...
struct X509Store_t2829  : public Object_t
{
	...
	X509Certificate2Collection_t2819 * ___list_2;
	...
	X509Store_t2844 * ___store_4;
};
struct X509Store_t2829_StaticFields{
	...
	Dictionary_2_t1822 * ___U3CU3Ef__switch$mapF_5;
};
