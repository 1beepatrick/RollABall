...
struct ClientSessionInfo_t3051  : public Object_t
{
	...
	ByteU5BU5D_t433* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t433* ___masterSecret_5;
};
struct ClientSessionInfo_t3051_StaticFields{
