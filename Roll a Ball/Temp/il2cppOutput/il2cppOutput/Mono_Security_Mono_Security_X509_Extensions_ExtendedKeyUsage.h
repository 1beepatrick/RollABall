...
struct ExtendedKeyUsageExtension_t3025  : public X509Extension_t2831
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t2764 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t3025_StaticFields{
	...
	Dictionary_2_t1822 * ___U3CU3Ef__switch$map14_4;
};
